...
export default function EditCustomerPage() {
  ...
  useEffect(() => {
    api
      ...
      .catch((err) =>
        setLoadError(describeApiError(err, "Couldn't load this customer.")),
      )
  ...
  return (
    <>
      <Topbar title="Edit customer" description={`Customer #${params.id}`} />
      <div className="flex-1 overflow-y-auto p-4 sm:p-6">
        {loading ? (
          <p className="text-sm text-ink-500">Loading customer…</p>
        ) : loadError ? (
