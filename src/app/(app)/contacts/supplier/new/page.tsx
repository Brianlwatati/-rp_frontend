...
export default function NewSupplierPage() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      setError(
        describeApiError(
          err,
          "Couldn't create this supplier. Check the fields and try again.",
        ),
      );
    } finally {
      setSubmitting(false);
  ...
  return (
    <>
      <Topbar title="New supplier" description="Add a new supplier record." />
        ...
        <form onSubmit={onSubmit} className="max-w-xl panel p-6 space-y-5">
          <Field label="Name" required>
            <input
              ...
              placeholder="Northwind Materials"
