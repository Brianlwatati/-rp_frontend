...
export default function SettingsPage() {
  ...
  return (
    <>
      <Topbar
        title="Settings"
        description="Your account and this workspace's defaults."
      />
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6 max-w-2xl">
        <div className="panel p-6">
          ...
          <div className="grid grid-cols-[120px_1fr] gap-y-3 text-sm">
            ...
            <span className="text-ink-100 font-mono break-all">
              {user?.email ?? "—"}
            </span>
        ...
        <div className="panel p-6">
          ...
          <p className="text-sm text-ink-300 mb-4">
            Signing out revokes this browser&apos;s token. You&apos;ll need to
            sign in again to reach any workspace.
          </p>
