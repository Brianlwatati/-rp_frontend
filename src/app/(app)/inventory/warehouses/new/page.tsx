...
export default function NewWarehousePage() {
    ...
    try {
      ...
      const message =
        err && typeof err === "object" && "message" in err
          ...
          : "Couldn't create the warehouse. Check the fields and try again.";
      setError(message);
    } finally {
      setSubmitting(false);
    }
  ...
  return (
    <>
      <Topbar
        title="New warehouse"
        description="Register a new stock location."
      />
      <InventoryTabs />
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6">
        <form onSubmit={onSubmit} className="max-w-xl panel p-6 space-y-5">
          <Field
            label="Code"
            required
            hint="Short internal identifier, e.g. WH-NBO"
          >
            <input
              required
              value={form.code}
          ...
          <Field label="Location" hint="Optional — city, region, or address.">
            <input
              value={form.location}
