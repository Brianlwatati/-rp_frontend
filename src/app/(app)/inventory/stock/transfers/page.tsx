...
export default function StockTransfersPage() {
  ...
  const columns: Column<StockTransfer>[] = [
    ...
    },
    {
      ...
      accessor: (t) =>
        t.productSku
          ? `${t.productSku} · ${t.productName}`
          : productLabel(t.productId),
    },
    {
      header: "From",
      accessor: (t) => t.fromWarehouseName ?? warehouseLabel(t.fromWarehouseId),
    },
    {
      header: "To",
      accessor: (t) => t.toWarehouseName ?? warehouseLabel(t.toWarehouseId),
    },
